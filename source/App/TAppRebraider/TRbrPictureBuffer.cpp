#include "TRbrPictureBuffer.h"


/**
 * Default constructor
 */
TRbrPictureBuffer::TRbrPictureBuffer() :
  m_list() {
}
 ...
 */
std::list<TComPic*>& TRbrPictureBuffer::list() {
  return m_list;
}
 ...
 */
const std::list<TComPic*>& TRbrPictureBuffer::list() const {
  return m_list;
}
 ...
 */
TComPic* TRbrPictureBuffer::find(Int poc) {
  return const_cast<TComPic*>(
    static_cast<const TRbrPictureBuffer*>(this)->find(poc)
  );
}
 ...
 */
const TComPic* TRbrPictureBuffer::find(Int poc) const {
...
TComPic*& TRbrPictureBuffer::getUnusedEntry() {
 ...
 */
TComPic* TRbrPictureBuffer::extract(Int poc) {
 ...
 */
Void TRbrPictureBuffer::remove(Int poc) {
  for (auto it = m_list.cbegin(); it != m_list.cend(); it++) {
    TComPic* pic = *it;
